...
var player
var level
var hud = preload("res://src/objects/ui/hud.tscn").instance()
var fps_label
...
func _ready() -> void:
	level = load("res://src/levels/%s.tscn" % _level).instance()
...
func spawn_dynamite() -> void:
	...
	var thingy = preload("res://src/objects/generic/dynamite_projectile.tscn").instance()
...
func use_treasure_spawner() -> void:
	var pos = $Level.get_global_mouse_position()
	var spawner = preload("res://src/objects/generic/pickup_spawner.tscn").instance()
...
func spawn_sword_projectile() -> void:
	var pos = $Level.get_global_mouse_position()
	var thingy = preload("res://src/objects/generic/sword_projectile.tscn").instance()
	level.add_child(thingy)
...
func spawn_random_treasure() -> void:
	var pos = $Level.get_global_mouse_position()
	var thingy = preload("res://src/objects/generic/treasure.tscn").instance()
	thingy.physics = true
...
func spawn_random_restore() -> void:
	var pos = $Level.get_global_mouse_position()
	var thingy = preload("res://src/objects/generic/restore.tscn").instance()
	thingy.physics = true
	thingy.one_use = true
	randomize()
...
func spawn_random_powerup() -> void:
	var pos = $Level.get_global_mouse_position()
	var thingy = preload("res://src/objects/generic/powerup.tscn").instance()
	thingy.physics = true
	thingy.one_use = true
